...
class AdministradorTest {
    ...
    Tarifa tarifa1 = new Tarifa(22.5, 287.5, TipoPrioridad.ALTA, 4500, TipoDistancia.CERCA);
    Tarifa tarifa2 = new Tarifa(45.2, 320.1, TipoPrioridad.BAJA, 8000, TipoDistancia.LEJANA);
    Tarifa tarifa3 = new Tarifa(85.4, 400.0, TipoPrioridad.MEDIA, 2500, TipoDistancia.LEJANA);
